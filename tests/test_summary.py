...
@pytest.mark.parity
@pending
def test_appends_text_to_summary_file(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_overwrites_text_to_summary_file(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_appends_text_with_eol_to_summary_file(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_chains_appends_text_to_summary_file(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_adds_eol(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_adds_a_code_block_without_language(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_adds_a_code_block_with_a_language(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_adds_an_unordered_list(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_adds_an_ordered_list(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_adds_a_table(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_adds_a_details_element(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_adds_an_image_with_alt_text(step_summary: StepSummaryWriter) -> None:
...
def test_adds_an_image_with_custom_dimensions(
    step_summary: StepSummaryWriter, occurrence: str
) -> None:
...
def test_adds_heading_at_level(step_summary: StepSummaryWriter, level: int) -> None:
...
def test_adds_h1_if_heading_level_not_specified(
    step_summary: StepSummaryWriter,
) -> None:
...
def test_uses_h1_if_heading_level_is_garbage_or_out_of_range(
    step_summary: StepSummaryWriter, level: int | str
) -> None:
...
@pytest.mark.parity
@pending
def test_adds_a_separator(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_adds_a_break(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_adds_a_quote(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_adds_a_quote_with_citation(step_summary: StepSummaryWriter) -> None:
...
@pytest.mark.parity
@pending
def test_adds_a_link_with_href(step_summary: StepSummaryWriter) -> None:
